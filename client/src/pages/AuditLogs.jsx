      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        <div style={{ flex: 1, padding: '24px 32px', overflowY: 'auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginTop: 32 }}>
            <div style={{ padding: '24px 28px', background: 'white', borderRadius: 16, boxShadow: '0 1px 2px rgba(0,0,0,.05)', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div style={{ fontSize: 10, fontWeight: 700, color: '#059669', textTransform: 'uppercase', letterSpacing: 1.2 }}>Security Score</div>
              <div style={{ fontSize: 36, fontFamily: 'JetBrains Mono,monospace', fontWeight: 700, color: '#281716' }}>98.2<span style={{ fontSize: 18, color: '#94A3B8' }}>%</span></div>
              <div style={{ height: 4, background: '#F1F5F9', borderRadius: 4, overflow: 'hidden' }}>
                <div style={{ height: '100%', width: '98.2%', background: 'linear-gradient(90deg, #059669, #10B981)', borderRadius: 4 }} />
              </div>
              <div style={{ fontSize: 11, color: '#64748B', fontWeight: 600 }}>● Excellent — No critical flags</div>
            </div>
            <div style={{ padding: '24px 28px', background: 'white', borderRadius: 16, boxShadow: '0 1px 2px rgba(0,0,0,.05)', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div style={{ fontSize: 10, fontWeight: 700, color: '#D97706', textTransform: 'uppercase', letterSpacing: 1.2 }}>Anomalies Detected</div>
              <div style={{ fontSize: 36, fontFamily: 'JetBrains Mono,monospace', fontWeight: 700, color: '#281716' }}>
                {String(logs.filter(l => l.status === 'failed').length).padStart(2, '0')}
              </div>
              <div style={{ fontSize: 11, color: '#64748B', fontWeight: 600 }}>Failed login attempts logged</div>
              <div style={{ fontSize: 11, color: '#D97706', fontWeight: 700 }}>● Under threshold — Monitoring active</div>
            </div>
            <div style={{ padding: '24px 28px', background: '#0B1C30', borderRadius: 16, boxShadow: '0 1px 2px rgba(0,0,0,.05)', display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div style={{ fontSize: 10, fontWeight: 700, color: '#10B981', textTransform: 'uppercase', letterSpacing: 1.2 }}>System Integrity</div>
              <div style={{ fontSize: 36, fontFamily: 'JetBrains Mono,monospace', fontWeight: 700, color: 'white' }}>ACTIVE</div>
              <div style={{ fontSize: 11, color: '#64748B', fontWeight: 600 }}>All modules reporting normally</div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#10B981', boxShadow: '0 0 8px rgba(16,185,129,.6)' }} />
                <span style={{ fontSize: 11, color: '#10B981', fontWeight: 700 }}>Carlmed Core — Online</span>
              </div>
            </div>
          </div>
